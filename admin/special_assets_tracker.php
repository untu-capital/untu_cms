                ...
                <div class="wizard-content">
                    <form method="POST" action="" class="tab-wizard wizard-circle wizard">
                        <div class="row">
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    <label for="type">Date of Acquisition :</label>
                                    <input id="name" name="name" type="date" class="form-control"/>
                                </div>
                            </div>
                            <div class="col-md-6">
                                <div class="form-group">
                                    <label for="name">Number of Shares :</label>
                                    <input id="name" name="name" type="number" class="form-control"/>
                                </div>
                            </div>
                        </div>
                    ...
                    <form class="tab-wizard wizard-circle wizard">
                        <section>
                            <div class="row">
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        <label for="phoneNumber">Date of Acquisition :</label>
                                        <input id="phoneNumber" name="phoneNumber" type="text" class="form-control"
                                               value="<?php echo $data['phoneNumber'] ?? ''; ?>"
                                               readonly="readonly"/>
                                    </div>
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        <label for="phoneNumberOther">Number of Shares :</label>
                                        <input id="phoneNumberOther" name="phoneNumberOther" type="text"
                                               class="form-control"
                                               value="<?php echo $data['phoneNumberOther'] ?? ''; ?>"
                                               readonly="readonly"/>
