        ...
        <?php if ($_GET['menu'] == 'main') { ?>
            <div class="col-lg-12 col-md-12 col-sm-12 mb-30">
                <div class="pd-20 card-box">
                    <h5 class="h4 text-blue mb-20">Recover Tracker</h5>
                    <div class="tab">
                        <ul class="nav nav-tabs customtab" role="tablist">
                            <li class="nav-item">
                                <a class="nav-link active" data-toggle="tab" href="#recoveries" role="tab"
                                   aria-selected="true">Recoveries</a>
                            </li>
                        ...
                        <div class="tab-content">
                            <div class="tab-pane fade show active" id="recoveries" role="tabpanel">
                                <div class="pd-20">
                                    <?php include('../includes/tables/recoveries/recoveries_table.php'); ?>
                                </div>
                            </div>
