<?php if ($_GET['menu'] == 'req'){ ?>
    <div class="col-lg-12 col-md-12 col-sm-12 mb-30">
        <div class="pd-20 card-box">
            ...
            <div class="row">
                <div class="col-10"><h5 class="card-title text-blue" style="text-decoration: underline;">PO NUMBER: #212177</h5></div>
                <div class="col-2"><h5 class="card-title text-blue" style="text-decoration: underline;">Status: OPEN (SAVE)</h5></div>
            </div>
                        ...
                        <table class="table hover table-striped multiple-select-row nowrap table-bordered" id="table_field">
                            ...
                            <?php foreach($req_trans as $row):?>
                                <tr>
                                    ...
                                    <td><?php echo $row['poSupplier'] ;?></td>
                                    <td><?php echo $row['poCategory'] ;?></td>
...
//                                        echo '<span class="file-tag">' . $filename . '</span>';
                        ...
                        <div class="custom-control custom-checkbox mb-5">
                            ...
                            <label class="custom-control-label" for="customCheck1-1"><b>Add Approvers</b> (If you need any other Approver besides your Supervisor)</label>
                        </div>
