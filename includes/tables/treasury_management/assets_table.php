    ...
    <table class="table hover table stripe multiple-select-row data-table-export nowrap">
        ...
        foreach ($liabilities as $data):
            ...
            <tr>
                ...
                <td class="table-plus"><?php echo $data['assetType']; ?></td>
...
<!--                            <a class="dropdown-item" href="treasury_management.php?menu=download_asset_deal_note&id=--><?php //= $data["id"] ?><!--&generate_asset_deal_note=true"><i class="dw dw-download"></i>Download D.N</a>-->
