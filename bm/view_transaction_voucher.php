        ...
        <div class="col-lg-12 col-md-12 col-sm-12 mb-30">
            <div class="pd-20 card-box">
                        ...
                        <div class="form-group row" <?php echo ($transactionVoucher['firstApprovalStatus'] == "APPROVED"  || $transactionVoucher['firstApprovalStatus'] == "REVISE") ? "hidden" : " " ?>>
                            ...
                            <div class="col-sm-6 col-md-6 col-form-label">
                                <button type="button" class="btn btn-warning btn-block"
                                        onclick="approveTransaction(<?= $transactionVoucher['id']; ?>, 'REVISE')">Revise
                                </button>
                            </div>
                        </div>
                        <div class="form-group row" <?php echo ($transactionVoucher['firstApprovalStatus'] == "APPROVED" || $transactionVoucher['firstApprovalStatus'] == "REVISE") ? " " : "hidden" ?>>
                ...
                <script>
                    ...
                    async function approveTransaction(id, status) {
                        ...
                        await fetch('http://localhost:7878/api/utg/cms/transaction-voucher/first-approve', {
                            ...
                            .then(data => {
                                console.log(data);
                                window.location.href = "http://localhost/untu-systems/bm/cash_management.php?menu=main";
                            })
                            .catch(error => {
                                // Handle errors here
